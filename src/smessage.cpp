// Copyright (c) 2014 The Nightmare developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("nightmare-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("nightmare-smsg-pow"); // Make this thread recognisable
