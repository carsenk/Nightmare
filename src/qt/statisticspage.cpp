...
void StatisticsPage::updateStatistics()
{
    ...
    {
		subsidy = "140000 NM per block";
    }
	else if(pindexBest->nHeight < 160)
    {
		subsidy = "0 NM per block";
    }
	else if(pindexBest->nHeight < 14000)
    {
		subsidy = "500 NM per block";
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"#ebbcff\">" + qVolume + " NM" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " NM" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " NM");
    }
